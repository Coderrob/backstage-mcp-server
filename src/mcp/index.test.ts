...
describe('MCP public module', () => {
  it('should expose the supported harness factories', () => {
    ...
    expect(typeof mcp.defineTool).toBe('function');
    expect(typeof mcp.defineResource).toBe('function');
    expect(typeof mcp.definePrompt).toBe('function');
    expect(typeof mcp.connectTestClient).toBe('function');
