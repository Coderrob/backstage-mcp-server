...
import { IApiDocument } from './apis.js';
import { IPaginationParams } from './paging.js';

/**
 * Interface for the Backstage Catalog API client provides
 * methods to interact with Backstage's catalog service
 */
export interface IBackstageCatalogApi {
   ...
   */
  getEntitiesJsonApi(request?: GetEntitiesRequest & IPaginationParams): Promise<IApiDocument>;
}
