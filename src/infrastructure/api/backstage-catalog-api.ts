...
import axios, { AxiosInstance, AxiosRequestHeaders, InternalAxiosRequestConfig, isAxiosError } from 'axios';
...
import { SecurityEventType } from '../../shared/types/events.js';
import { IPaginationParams } from '../../shared/types/paging.js';
import { EntityRef } from '../../shared/utils/entity-ref.js';
import { isDefined, isNonEmptyString, isNumber, isString } from '../../shared/utils/guards.js';
...
export class BackstageCatalogApi implements IBackstageCatalogApi {
  ...
  async getEntities(
    request?: GetEntitiesRequest & IPaginationParams,
   ...
   */
  async getEntitiesJsonApi(request?: GetEntitiesRequest & IPaginationParams): Promise<IApiDocument> {
