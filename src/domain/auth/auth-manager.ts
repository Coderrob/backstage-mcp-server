...
import { validateRequiredConfig } from '../../shared/utils/validation.js';
...
export class AuthManager {
  ...
  private refreshPromise?: Promise<ITokenInfo>;
   ...
   * @private
   */
  private async handleBearerToken(): Promise<ITokenInfo> {
   ...
   * @private
   */
  private async handleOAuthRefresh(): Promise<ITokenInfo> {
   ...
   * @private
   */
  private async handleApiKey(): Promise<ITokenInfo> {
   ...
   * @private
   */
  private async handleServiceAccount(): Promise<ITokenInfo> {
   ...
   * @private
   */
  private parseOAuthResponse(response: AxiosResponse): ITokenInfo {
