...
| ADR                                                                   | Decision                                                                | Status     |
| --------------------------------------------------------------------- | ----------------------------------------------------------------------- | ---------- |
| [0001](0001-generic-mcp-application-kernel.md)                        | Adopt a generic MCP application kernel                                  | Superseded |
| [0002](0002-source-boundaries-and-single-package.md)                  | Organize cohesive source boundaries in a single package                 | Superseded |
...
- Use `Proposed`, `Accepted`, `Deprecated`, `Superseded`, or `Superseded by ADR NNNN` as its status.
- Do not rewrite an accepted decision when the architecture changes. Add a replacement ADR when the new decision still belongs to this repository; use `Superseded` with a current-guide link when ownership moves outside it.
